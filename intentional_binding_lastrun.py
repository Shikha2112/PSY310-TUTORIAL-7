...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Neha N Shah\\Downloads\\PSY310\\intentional_binding_lastrun.py',
...
polygon_2 = visual.ShapeStim(
    ...
    size=(0.2, 0.2), vertices='circle',
    ori=0.0, pos=(0, 0), anchor='center',
    lineWidth=1.0,     colorSpace='rgb',  lineColor=[0.3961, -0.7333, -0.7333], fillColor=[0.3961, -0.7333, -0.7333],
...
text = visual.TextStim(win=win, name='text',
    text='Report the deplay between the key press and the beep sound (0-999); click submit after entering the value',
    font='Open Sans',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('Conditions_intentional_binding.xlsx'),
